...
<CardGroup cols={2}>
  <Card title="Compression Gauntlet" href="/docs/cookbook/compression-gauntlet/README">
    A chain that halves the text each step — how much can survive?
  </Card>
  <Card title="Sequential Pipeline" href="/docs/cookbook/sequential-pipeline/README">
