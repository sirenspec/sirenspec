...
See [`examples/market-analysis-swrm.yaml`](https://github.com/TJLSmith0831/sirenspec/blob/main/examples/market-analysis-swrm.yaml) for a full working workflow.
